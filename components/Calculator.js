    ...
    <div>
      <form>
        <fieldset className="mt-5 md:mt-9">
          <legend className="text-3xl md:text-5xl text-center leading-6">
            Select Sport:
          </legend>
          <div className="flex space-x-9 justify-center my-5">
            <div>
              <input
                ...
                name="swim"
                type="checkbox"
                className="h-4 w-4 md:h-5 md:w-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"
                checked={isSwimChecked}
                onChange={handleCheckboxChange}
              />
              <label htmlFor="swim" className="ml-2 text-xl md:text-3xl">
                Swim
              </label>
            </div>
            <div>
              <input
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="Bike" className="ml-2 text-xl md:text-3xl">
                Bike
              </label>
            </div>
            <div>
              <input
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="run" className="ml-2 text-xl md:text-3xl">
                Run
              </label>
            </div>
          </div>
