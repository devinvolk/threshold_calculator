...
const About = () => {
  return (
    <div className='mt-5 px-5 md:mt-10'>
        ...
        <span className='font-bold capitalize'> critical power (CP)</span>, 
        is crucial for tailoring training programs to specific needs. 
        ...
        while minimizing the risk of <span className='font-bold underline decoration-black'>overtraining</span> and 
        ...
        triathlon training strategies, ensuring that athletes reach their peak fitness levels and achieve their competitive goals.
        </p>
    </div>
  )
}
